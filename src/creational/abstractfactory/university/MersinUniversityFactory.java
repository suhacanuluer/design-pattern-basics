...
public class MersinUniversityFactory implements UniversityFactory {

    private LocalDateTime now;
    @Override
    public Rector createRector(String name) {
        now = LocalDateTime.now();
        System.out.println("Mersin University Rector created");
    ...
    public Student createBusinessStudent(String name, String car) {
        now = LocalDateTime.now();
        System.out.println("Mersin University Business Student created");
    ...
    public Student createComputerEngineeringStudent(String name) {
        now = LocalDateTime.now();
        System.out.println("Mersin University Computer Engineering Student created");
    ...
    public Student createElectricalEngineeringStudent(String name) {
        now = LocalDateTime.now();
        System.out.println("Mersin University Electrical Engineering Student created");
